...
function NavigationMenuTrigger(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(NavigationMenuPrimitive.Trigger, __assign({ "data-slot": "navigation-menu-trigger", className: (0, utils_1.cn)(navigationMenuTriggerStyle(), "group", className) }, props, { children: [children, " ", (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronDownIcon, { className: "relative top-[1px] ml-1 size-3 transition duration-300 group-data-[state=open]:rotate-180", "aria-hidden": "true" })] })));
}
