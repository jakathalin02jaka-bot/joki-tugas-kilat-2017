...
function Button(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(Comp, __assign({ "data-slot": "button", "data-variant": variant, "data-size": size, className: (0, utils_1.cn)(buttonVariants({ variant: variant, size: size, className: className })) }, props)));
}
